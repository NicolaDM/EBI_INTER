...
# Import data
```{r}
data_ERR <- read.table("../../IntermediateDATA/P1-ERR_POS_all.txt", header = TRUE, sep = "\t")
...
ggsave("ERRPOS.png", plot = final_plot, width = 10, height = 10)
...
ggsave("ALLPOS.png", plot = final_plot, width = 10, height = 10)
