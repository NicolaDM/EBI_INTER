...
Err_same@region[["count"]][1] <- 1916402170
Err_same@region[["count"]][2] <- 1919298481
Err_same@region[["count"]][3] <- 1716486166
Err_same@region[["count"]][4] <- 9139461
Err_same@region[["count"]][5] <- 895787
Err_same@region[["count"]][6] <- 294907
Err_same@region[["count"]][7] <- 187103
```
...
"#A51919",
"#800000"), 
                       values = c(0, 0.01, 0.04, 0.08, 0.1, 0.3, 0.5, 0.7, 0.8, 0.9, 1), limits = c(0, 2000000000), guide = "none")+
    scale_color_manual(values = manual_colors)+
...
final_plot <- plot_grid(
  ...
  ggplot() +
    ...
    scale_fill_gradientn(colors = c("#F4FAFE","#EBF6FD","#E2F3FC","#D9EFFB","#ACDEF6","#A3DBF5","#9AD8F4","#91D4F3","#82C7F8","#6FBEF7","#5CB6F6","#499DF5"), 
                  values = c(0, 0.01, 0.04, 0.08, 0.1, 0.3, 0.5, 0.7, 0.9, 1), limits = c(0, 49000000), guide = "none")+
    scale_color_manual(values = manual_colors)+
    theme(panel.border = element_rect(colour = "white", fill=NA, size=1.5),   # 给图加一个边框
