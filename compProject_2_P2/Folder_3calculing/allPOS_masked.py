...
def count_statistics(df, flag_name, count_dict):
...
def process_file(file_name):
    ...
    count_statistics(df, 'masked', local_count_dict)  # ' the number of positions that are nucleotides in the DataPortal but masked in Viridian'
