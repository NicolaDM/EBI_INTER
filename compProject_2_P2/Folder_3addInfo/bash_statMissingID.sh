...
echo "================ Stat total ================"
echo "The total number of missing IDs is: $(( $(wc -l < /nfs/research/goldman/zihao/Datas/p2_comp_viridian/Folder_3_mergeINFO/missing_ann_ids.txt) + $(wc -l < /nfs/research/goldman/zihao/Datas/p2_comp_viridian/Folder_3_mergeINFO/missing_cov_ids.txt) ))"
